        ...
        <div id="content" class="fl-right">
                ...
                <div class="section-detail">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp product">
                            ...
                            <tbody>
                                <?php
                                if (!empty($list_product_pending)) {
                                    $i = 0;
                                    foreach ($list_product_pending as $item) {
                                        $i ++;
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <?php echo get_pagging($num_page, $page, $base_url = "?mod=product&controller=index&action=product_pending");?>
                </div>
            </div>
        </div>
    </div>
