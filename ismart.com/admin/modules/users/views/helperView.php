...
<div id="main-content-wp" class="list-post-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            ...
            <h3 id="index" class="fl-left">Danh sách cộng tác viên</h3>
        </div>
    </div>
        ...
        <div id="content" class="fl-right">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                ...
                                <?php
                                if (!empty($list_user_helper)) {
                                    $i = $start;
                                    foreach ($list_user_helper as $user) {
                                        $i ++;
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, $base_url="?mod=users&controller=team&action=helper");?>
                </div>
            </div>
        </div>
    </div>
