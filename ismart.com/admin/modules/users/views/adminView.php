<?php 
 //echo get_num_user_by_role(3);
//show_array($list_user_admin);
get_header(); 
?>
        ...
        <div id="content" class="fl-right">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                ...
                                if (!empty($list_user_admin)) {
                                    $i = $start;
                                    foreach ($list_user_admin as $user) {
                                        $i ++;
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, $base_url="?mod=users&controller=team&action=admin");?>
                </div>
            </div>
        </div>
    </div>
