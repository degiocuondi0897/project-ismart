...
<div id="main-content-wp" class="list-post-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            ...
            <h3 id="index" class="fl-left">Danh sách người quản trị</h3>
        </div>
    </div>
        ...
        <div id="content" class="fl-right">
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            ...
                            <li class="public"><a href="?mod=users&controller=team&action=admin">Người quản trị (<span class="count"><?php echo get_list_user_by_role(3); ?></span>)</a> |</li>
                            <li class="helper"><a href="?mod=users&controller=team&action=helper">Công tác viên(<span class="count"><?php echo get_list_user_by_role(2); ?></span>)</a></li>
                            <li class="trash"><a href="">Thùng rác (<span class="count"><?php echo get_list_user_by_role(1); ?></span>)</a></li>
                        </ul>
                        <form method="POST" action="<?php echo base_url('?mod=users&controller=team&action=search'); ?>" class="form-s fl-right">
                            <input type="text" name="search" id="search">
                            <input type="submit" name="sm_search" id="sm_search" value="Tìm kiếm">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                ...
                                if (!empty($list_user)) {
                                    ...
                                    <tr id="row_user_<?php echo $user['user_id']; ?>">
                                        ...
                                        <td class="clearfix">
                                            ...
                                            <div class="list-operation-user fl-right">
                                                <form action="?mod=users&controller=team" method="POST">
                                                    ...
                                                    <button title="Xóa" class="delete" id="<?php echo $user['user_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                </form>
                                            </div>
                                        </td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, $base_url="?mod=users&controller=team&action=index");?>
                </div>
            </div>
        </div>
    </div>
