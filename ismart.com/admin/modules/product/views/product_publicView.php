<?php
//show_array($list_product_public);
get_header();
?>
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <div class="actions">
                        <form method="POST" action="?mod=product&controller=index&action=actions" class="form-actions">
                            <select name="actions">
                    ...
                    <!--Hiển thị thông tin khi tìm kiếm-->
                    <div id="show_info_search_product">
                    </div>
                    <!---------------------------------------->
                    <div class="table-responsive">
                        <table class="table list-table-wp product">
                            ...
                            <tbody>
                                <?php
                                if (!empty($list_product_public)) {
                                    $i = 0;
                                    foreach ($list_product_public as $item) {
                                        $i ++;
                                        $item['show_status'] = array(
                                            1 => "<p style='color: #f15959a8;'>Thùng rác<p>",
                                            2 => "<p style='color: red;'>Chờ duyệt<p>",
                                        ...
                                        <tr id="row_product_<?php echo $item['product_id']; ?>">
                                            ...
                                            <td class="clearfix">
                                                ...
                                                <form action="?mod=product&controller=index" method="POST" class="list-operation fl-right">
                                                    <button title="Sửa" class="edit product"><i class="fa fa-pencil" aria-hidden="true"></i></button>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <?php echo get_pagging($num_page, $page, $base_url = "?mod=product&controller=index&action=product_public");?>
                </div>
            </div>
        </div>
    </div>
